...
function personal_portfolio_scripts() {
	...
	wp_enqueue_script('jquery', 'https://ajax.googleapis.com/ajax/libs/jquery/3.1.1/jquery.min.js', array(), null, true,  $in_footer = false);

	wp_enqueue_script( 'bootstrap-js', get_template_directory_uri() . '/js/bootstrap.min.js', array(), '20151215', true,  $in_footer = false );

	wp_enqueue_script( 'MatchHeigh-js', get_template_directory_uri() . '/js/jquery.matchHeight.js', array(), '20151215', true,  $in_footer = false );

	wp_enqueue_script( 'personal-portfolio-navigation', get_template_directory_uri() . '/js/navigation.js', array(), '20151215', true,  $in_footer = false );

	wp_enqueue_script( 'personal-portfolio-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', array(), '20151215', true,  $in_footer = false );

	wp_enqueue_script( 'personal-portfolio-custom-script', get_template_directory_uri() . '/js/custom.js', array(), '20151215', true, $in_footer = false );
